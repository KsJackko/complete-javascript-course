...
/*
const yuki = new StudentCl('Yuki Zhang', 2010, 'Computer Science');
yuki.introduce();
yuki.calcAge();
console.log(yuki);
...
const mov = acc1.deposit(250).deposit(50).deposit(250).getMovement();
...
rivian.accelerate().accelerate().chargeBattery(100).brake().accelerate();
